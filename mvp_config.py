...
BASE_MVP_CONFIG: dict = {
    ...
    "buy_threshold_quantile": 0.95,
    "sell_threshold_quantile": 0.95,
    "trade_direction_mode": "sell_only",
    "run_probability_bucket_analysis": False,
    "run_sell_threshold_grid": True,
    "sell_threshold_grid_quantiles": [0.90, 0.92, 0.94, 0.95, 0.96, 0.97],
